  ...
  <section class="combo-page">
    <header class="combo-hero">
      ...
      <div class="combo-hero__stats" aria-hidden="true">
        <div><strong>{{ AllCombos.length }}</strong><span>{{ Text.ComboCountSuffix }}</span></div>
    ...
    <section class="combo-catalog">
      <div class="combo-section__header">
        <div>
          <span class="combo-section__eyebrow">{{ FilteredCombos.length }} {{ Text.ComboCountSuffix }}</span>
