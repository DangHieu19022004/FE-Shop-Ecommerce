<template>
  <section class="admin-page">
    ...
    <div class="admin-metrics">
      ...
      <article class="dm-card admin-metric"><span class="admin-metric__label">{{ Text.Margin }}</span><div class="admin-metric__value">{{ formatI18nText(Text.MarginValue, { value: ProfitMargin.toFixed(1) }) }}</div></article>
    </div>
